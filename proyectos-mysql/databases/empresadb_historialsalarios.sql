...
--
-- Table structure for table `historialsalarios`
--

DROP TABLE IF EXISTS `historialsalarios`;
...
--
-- Dumping data for table `historialsalarios`
--

LOCK TABLES `historialsalarios` WRITE;
/*!40000 ALTER TABLE `historialsalarios` DISABLE KEYS */;
/*!40000 ALTER TABLE `historialsalarios` ENABLE KEYS */;
UNLOCK TABLES;
